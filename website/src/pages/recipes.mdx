...
import { getDynamicContext, schema } from './my-graphql';
...
useServer(
  {
    context: (ctx, id, subscribePayload, args) => {
      return getDynamicContext(ctx, id, subscribePayload, args);
...
import { checkIsAdmin, getDebugSchema, schema } from './my-graphql';
...
useServer(
  {
    schema: async (ctx, id, subscribePayload, executionArgsWithoutSchema) => {
