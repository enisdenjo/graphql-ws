[@enisdenjo/graphql-transport-ws](../README.md) › ["message"](_message_.md)
...
*Defined in [message.ts:65](https://github.com/enisdenjo/graphql-transport-ws/blob/923625c/src/message.ts#L65)*
