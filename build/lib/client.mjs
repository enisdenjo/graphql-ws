 ...
 *
 */
import { DEPRECATED_GRAPHQL_WS_PROTOCOL, CloseCode, MessageType, parseMessage, stringifyMessage, } from './common.mjs';
...
export function createClient(options) {
    ...
    async function connect() {
        const [socket, throwOnClose] = await (connecting !== null && connecting !== void 0 ? connecting : (connecting = new Promise((connected, denied) => (async () => {
            ...
            const socket = new WebSocketImpl(typeof url === 'function' ? await url() : url, DEPRECATED_GRAPHQL_WS_PROTOCOL);
